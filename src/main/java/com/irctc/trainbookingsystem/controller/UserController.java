...
public class UserController {
	...
	private UserService userService;
	  ...
	  @PostMapping("/addUser") public ResponseEntity<?> addNewUser(@RequestBody
	  UserDto userDto) {
	...
	/*
	 * @PostMapping("/addUser") public ResponseEntity<?> addNewUser(Model m) {
	 * UserDto userDto=new UserDto();
	 * userDto.setUserName(m.getAttribute("userName")));
	 * 
	 * return new ResponseEntity<>(userService.addUser(userDto),
	 * HttpStatus.CREATED); }
	 */
